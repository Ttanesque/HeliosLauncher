...
/**
 * Fetches the atom release feed and parses it for the release notes
 * of the current version. This value is displayed on the UI.
 */
function populateReleaseNotes() {
    $.ajax({
        url: 'http://www.minenorthrp.fr/mineNorth/release/release.atom',
        success: (data) => {
